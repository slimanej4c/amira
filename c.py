...
class job:
    ...
    def frame1(self):
        ...
        bdemarer=Button(self.haut_frame3,command=self.frame,text='démarer',image=self.bimage)
    ...
    def bautton(self):
        ...
        self.combo_percentage = ttk.Combobox(self.haut_frame2,
        ...
        self.banalyse = Button(self.gauche_frame, text='analyse data test', width=self.x // 40, bg='#008000',
                               fg='white', relief=GROOVE)
        self.bexport = Button(self.gauche_frame, text='export data', width=self.x // 40, bg='#008000', fg='white',
                              relief=GROOVE)
        self.baffiche = Button(self.haut_frame3, text='afficher test final', width=self.x // 40, bg='#008000',
                               fg='white', relief=GROOVE)
    ...
    def tf_idf_1(self):
        ...
        self.bscore = Button(self.gauche_frame, text='afficher le score',
                             command=lambda: self.go_train.tester(vscore, self.butiliser_model),
                             width=self.x // 40, bg='#0000FF',
                             fg='white', relief=GROOVE, )
        ...
        self.bentrainer = Button(self.gauche_frame, text=v,
                                 command=lambda: self.go_train.entrainer(self.bscore, self.root), width=self.x // 40,
                                 bg='#0000FF',
                                 fg='white', relief=GROOVE, )
    ...
    def tf_idf_2(self):
        ...
        self.bafficheidf_test = Button(self.haut_frame3, text='afficher idf_tf test', command=self.goo.afficher_idf,
                                       width=self.x // 40, bg='#008000', fg='white', relief=GROOVE, )

        self.bafficheidf_test.grid(row=0, column=3)

        self.banalyse.configure(
            command=lambda: self.go_train.utiliser_svm(self.centre_frame1, self.data2, self.bexport, self.baffiche))
    ...
    def depart(self):
        ...
        self.btrain_Data1 = Button(self.droit_frame, text='import data train', width=self.x // 40, bg='#0000FF',
                                   fg='white', relief=GROOVE, command=lambda: self.set_data('train'))
    ...
    def load_csv(self, chemin, v):
        if v == 'train':
            ...
            self.btrain = Button(self.haut_frame3, text='afficher train data',
                                 command=lambda: self.affiche_data(self.data, 'train'), width=self.x // 40,
                                 bg='#0000FF',
                                 fg='white', relief=GROOVE, )
        ...
        if v == 'test':
            ...
            self.btest = Button(self.haut_frame3, text='afficher test data',
                                command=lambda: self.affiche_data(self.data2, 'test'),
